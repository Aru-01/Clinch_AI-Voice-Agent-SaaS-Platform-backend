...
login_schema = {
    ...
    "request_body": openapi.Schema(
        ...
        properties={
            'email': openapi.Schema(type=openapi.TYPE_STRING, format='email', example="arif@example.com"),
...
resend_otp_schema = {
    ...
    "responses": {
        ...
        429: openapi.Response(
            ...
            examples={"application/json": {"error": "Please wait 30 seconds before requesting another OTP.", "wait_time": 30}}
        )
    }
}
...
forgot_password_schema = {
    ...
    "responses": {
        200: openapi.Response(
            ...
            examples={"application/json": {"message": "If an account exists with this email, a reset code has been sent."}}
        )
    }
}
...
reset_password_schema = {
    ...
    "request_body": openapi.Schema(
        ...
        properties={
            'email': openapi.Schema(type=openapi.TYPE_STRING, format='email', example="arif@example.com"),
            'otp': openapi.Schema(type=openapi.TYPE_STRING, example="1234"),
            'new_password': openapi.Schema(type=openapi.TYPE_STRING, min_length=8, example="new_secret_pass")
        }
    ),
    "responses": {
        200: openapi.Response(
...
change_password_schema = {
    ...
    "request_body": openapi.Schema(
        ...
        properties={
            'old_password': openapi.Schema(type=openapi.TYPE_STRING, example="old_secret_123"),
            'new_password': openapi.Schema(type=openapi.TYPE_STRING, min_length=8, example="new_secret_456"),
            'confirm_password': openapi.Schema(type=openapi.TYPE_STRING, example="new_secret_456")
        }
    ),
    "responses": {
        200: openapi.Response(
